import { type LiMove } from "./Lichess";
...
export function getRawScore(isWhite: boolean, move: LiMove): number {
  // ignore draws
  // SCORE_FLUKE_DISCOUNT discounts positions
  // that are very rare
  const winRate =
