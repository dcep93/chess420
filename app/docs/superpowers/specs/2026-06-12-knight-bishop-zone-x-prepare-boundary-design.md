...
- `n72`, `n74`, and `n75` should be covered by the pre-`[prepare]` handoff/key-square rule, like `n41`.
...
- `n41`, `n72`, `n74`, and `n75` should not be rule gaps because the pre-`[prepare]` handoff rule explains them.
...
- the pre-`[prepare]` reason for `n41`, `n72`, `n74`, `n75`.
